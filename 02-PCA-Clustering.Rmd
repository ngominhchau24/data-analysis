...
# Đọc lại dữ liệu (nếu chưa có trong environment)
if(!exists("data")) {
...
```{r pca-chemical}
# PCA cho biến hóa lý
data_chem <- data[, chemical_vars]
data_chem_complete <- data_chem[complete.cases(data_chem), ]
location_chem <- data$Localisation[complete.cases(data_chem)]
