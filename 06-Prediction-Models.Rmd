...
# Đọc dữ liệu
coffee_data <- read.csv("coffee_nirs.csv")

# Hàm chuyển đổi số kiểu Châu Âu
...
nir_vars <- names(coffee_data)[grepl("^S[0-9]+$", names(coffee_data))]
...
for(i in 1:length(chemical_vars)) {
  ...
  pls_performance$R2[i] <- r2_train$val[1, 1, ncomp + 1]
}
