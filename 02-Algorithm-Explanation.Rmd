...
```{r pca-illustration, echo=FALSE, fig.width=10, fig.height=10, fig.cap="Minh họa PCA: Từ nhiều chiều xuống 2 chiều"}
par(mfrow = c(2, 1))
...
```{r clustering-illustration, echo=FALSE, fig.width=10, fig.height=10, fig.cap="Minh họa Clustering"}
par(mfrow = c(2, 1))
...
```{r outlier-illustration, echo=FALSE, fig.width=10, fig.height=10, fig.cap="Minh họa Outlier Detection"}
par(mfrow = c(2, 1))
...
```{r correlation-illustration, echo=FALSE, fig.width=6, fig.height=4, fig.cap="Minh họa Correlation"}
par(mfrow = c(1, 3))
...
```{r prediction-illustration, echo=FALSE, fig.width=6, fig.height=4, fig.cap="Minh họa Prediction Models"}
par(mfrow = c(1, 2))
